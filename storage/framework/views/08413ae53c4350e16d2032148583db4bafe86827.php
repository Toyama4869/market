        ...
        <?php endif; ?>
          ...
          <li><?php echo e($post->description); ?></li>
            <div class="post_body_footer">
                  <a class="like_button"><?php echo e($post->isLikedBy(Auth::user()) ? '★' : '☆'); ?></a>
...
<?php echo $__env->make('layouts.logged_in2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_market\resources\views/posts/find.blade.php ENDPATH**/ ?>