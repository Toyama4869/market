...
<div class="form">
   ...
   <div class="post_comments">
            ...
            <?php if($post->isOrderedBy($post)): ?>
                  [<span class="error">売り切れ</span>]
                    <?php else: ?>
                    <form class="confirm" action="<?php echo e(route('posts.confirm', $post)); ?>">
                        <form class="confirm" action="<?php echo e(route('posts.toggle_order', $post)); ?>">
                        <a href="<?php echo e(route('posts.confirm', $post->id)); ?>"><button class="button" type="button">購入する</button></a>
                        </form>
                    <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.logged_in', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_market\resources\views/posts/show.blade.php ENDPATH**/ ?>