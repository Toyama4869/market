...
<div class="body">
      ...
      <li class="post">
        ...
        <?php if(Auth::user()->isFollowing($post->user)): ?>
          <form method="post" action="<?php echo e(route('follows.destroy', $post->user)); ?>" class="follow">
            <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
          <form method="post" action="<?php echo e(route('follows.store')); ?>" class="follow">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="follow_id" value="<?php echo e($post->user->id); ?>">
...
<?php echo $__env->make('layouts.logged_in', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_market\resources\views/posts/index.blade.php ENDPATH**/ ?>